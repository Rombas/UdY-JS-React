...
Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', '.decoration_item > div', '.decoration_content > div > div', 'after_click');
...
var forms = function forms(formsSelector) {
  var formsArray = document.querySelectorAll(formsSelector);
  var status = document.createElement('div');
  formsArray.forEach(function (form) {
    var valid = true;
    var phoneInput = form.querySelector('[name="user_phone"]');
    ...
    form.addEventListener('submit', function (e) {
      ...
      if (valid) {
        ...
        console.log(p);
        p.append(status);
        postData('http://localhost:3000/requests', data) // postData('assets/server.php', data)
        .then(status.innerHTML = 'Done').catch(status.innerHTML = 'Some error').finally(setTimeout(function () {
...
var createModalFunctionality = function createModalFunctionality(openSelectors, modalForm, closeSelector) {
  var timerId = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
  var openBtns = document.querySelectorAll(openSelectors),
...
var tabs = function tabs(headerSelector, btnSelector, contentSelector, activeClass) {
